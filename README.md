## Meteor Handsontable (@version 0.9.0)
This package uses the latest version of Handsontable (currently @version 0.17.0) in MeteorJS.
...
## Important Notes
This package contains the latest yet slightly modified version of Handsontable (ver 0.17.0). Minor change has been made to the UI as well.     
...
## Versions Tracking
* Handsontable - 0.17.0  [Release Notes](https://github.com/handsontable/handsontable/releases)
* ruleJS - 0.0.5
